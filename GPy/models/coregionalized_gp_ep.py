...
class CoregionalizedGPEP(GP):
    ...
    def __init__(self,X_list,Y_list,kernel_list=None,noise_models_list=None,normalize_X=False,normalize_Y=False,rank=1):
        ...
        likelihood = likelihoods.EPMixedNoise(Y_list,noise_models_list=noise_models_list)
