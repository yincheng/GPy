...
class GPCorregionalizedEP(GP):
    """
    Multiple output Gaussian process with non-Gaussian noise
    ...
    def __init__(self,X_list,Y_list,kernel_list=None,noise_model_list=None,normalize_X=False,normalize_Y=False,rank=1):
        #NOTE normalize_Y not available
